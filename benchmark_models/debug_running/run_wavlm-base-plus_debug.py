...
if __name__=="__main__":
    c=WavLMConfig(vocab_size=32,hidden_size=64,num_hidden_layers=1,num_attention_heads=2,
    ...
    run_candidate(parser().parse_args(),"WavLM-base-plus",c,WavLMForCTC,"wavlm",602)

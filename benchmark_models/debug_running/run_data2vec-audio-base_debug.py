...
if __name__=="__main__":
    c=Data2VecAudioConfig(vocab_size=32,hidden_size=32,num_hidden_layers=1,num_attention_heads=1,
        intermediate_size=64,conv_dim=(16,32),conv_kernel=(10,3),conv_stride=(5,2),
        num_conv_pos_embeddings=1,num_conv_pos_embedding_groups=4,apply_spec_augment=False,

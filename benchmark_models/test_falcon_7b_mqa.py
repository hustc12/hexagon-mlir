...
def falcon_7b_mqa(enablelwp=False): 
    ...
    # Note: Using from_pretrained will download the weights directly from Hugging Face (~15GB).
    # If you just want to test compilation without downloading large weights,

...
ax.set_title('Ablation Study: 4-Stage Performance Breakdown', fontsize=15, fontweight='bold', pad=30)
ax.set_yscale('log')
ax.set_ylim(bottom=100, top=10**4.2) # 预留空间
...
def add_labels(rects, text_color):
    for rect in rects:
        ...
        ax.annotate(f'{h:.1f}',
                    ...
                    ha='center', va='bottom', fontsize=7, fontweight='bold', color=text_color)

...
bash "${repo_dir}/scripts/apply_hexagon_only_triton_patch.sh"

bash "${repo_dir}/scripts/build_upstream_llvm.sh"
...
bash "${repo_dir}/scripts/build_hexagon_mlir_incremental.sh" \

...
litert_work="${LITERT_WORK_DIR:-/tmp/litert-qnn226-alps}"
bazel_host_root="${LITERT_BAZEL_HOST_ROOT:-/tmp/litert-bazel-qnn226-alps-host}"
bazel_android_root="${LITERT_BAZEL_ANDROID_ROOT:-/tmp/litert-bazel-qnn226-alps-android}"
...
output_dir="${OUTPUT_DIR:-/tmp/alps-baselines/dinov2-debug-litert}"
device_serial="${ANDROID_SERIAL:-49d1c7b2}"
device_dir="${LITERT_DEVICE_DIR:-/data/local/tmp/alps_baselines/dinov2_debug_litert}"

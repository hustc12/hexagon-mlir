...
#include "hexagon/Conversion/AlpsToLLVM/Passes.h"
...
int main(int argc, char **argv) {
  ...
  mlir::hexagon::registerAlpsAttentionDestinationFormationPass();
  ...
  mlir::hexagon::registerAlpsPatchConvFormationPass();
  mlir::hexagon::registerAlpsHVXWideningConvPass();
  mlir::hexagon::registerAlpsContractDischargeLedgerPass();
  mlir::hexagon::registerAlpsContinuityAuditPass();
  mlir::hexagon::registerAlpsLayoutSupplyPrefetchPass();
  mlir::hexagon::registerAlpsCrpSupplyAnalysisPass();
  mlir::hexagon::registerAlpsCrpSupplyPrefetchPass();
  mlir::hexagon::registerAlpsCrpVtcmFormationPass();
  mlir::hexagon::registerAlpsCrpVtcmWindowPass();
  mlir::hexagon::registerAlpsCrpProducerDirectAnalysisPass();
  mlir::hexagon::registerAlpsVDAEInsertPass();
  mlir::hexagon::registerLayoutOpsEliminationPass();
  mlir::alps::registerAlpsToLLVMPass();

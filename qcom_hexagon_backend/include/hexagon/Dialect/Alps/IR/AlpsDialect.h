...
#ifndef HEXAGON_DIALECT_ALPS_IR_ALPS_DIALECT_H
#define HEXAGON_DIALECT_ALPS_IR_ALPS_DIALECT_H
...
//===----------------------------------------------------------------------===//
// Alps Dialect – auto-generated dialect declarations
//===----------------------------------------------------------------------===//
#include "hexagon/Dialect/Alps/IR/AlpsDialect.h.inc"

//===----------------------------------------------------------------------===//
// Alps Enums / Attributes – auto-generated
//===----------------------------------------------------------------------===//
#define GET_ATTRDEF_CLASSES
#include "hexagon/Dialect/Alps/IR/AlpsEnums.h.inc"
#include "hexagon/Dialect/Alps/IR/AlpsAttrs.h.inc"

//===----------------------------------------------------------------------===//
// Alps Ops – auto-generated
//===----------------------------------------------------------------------===//
#define GET_OP_CLASSES
#include "hexagon/Dialect/Alps/IR/AlpsOps.h.inc"
...
#endif // HEXAGON_DIALECT_ALPS_IR_ALPS_DIALECT_H

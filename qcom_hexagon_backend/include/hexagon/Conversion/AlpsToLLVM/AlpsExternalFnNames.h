//===- AlpsExternalFnNames.h - Runtime symbol names  -----------------===//
//
// Copyright (c) Qualcomm Technologies, Inc. and/or its subsidiaries.
// SPDX-License-Identifier: BSD-3-Clause.
//
//===----------------------------------------------------------------------===//
// Canonical names of the Hexagon device-side ALPS runtime functions.
// These must match exactly what AlpsRuntime.c exports.
//===----------------------------------------------------------------------===//

#ifndef HEXAGON_CONVERSION_ALPSTOLLVM_ALPSEXTERNALFNNAMES_H
#define HEXAGON_CONVERSION_ALPSTOLLVM_ALPSEXTERNALFNNAMES_H
...
inline llvm::StringRef getL2HintSegmentedFnName() {
  return "__alps_l2_hint_segmented";
}
...
inline llvm::StringRef getSetDualThreadDaeFnName() {
  return "__alps_set_dual_thread_dae";
}
...
inline llvm::StringRef getWhCacheSetContextFnName() {
  return "__alps_wh_cache_set_context";
}

inline llvm::StringRef getWhCacheInvalidateFnName() {
  return "__alps_wh_cache_invalidate";
}

inline llvm::StringRef getWhCacheStatsFnName() {
  return "__alps_wh_cache_stats";
}

} // namespace alps
} // namespace mlir

#endif // HEXAGON_CONVERSION_ALPSTOLLVM_ALPSEXTERNALFNNAMES_H

...
#activation = #omni_fetch.layout_transform<hmx_activation>
...
func.func @carry_unit_batch_activation(
  ...
  omni_fetch.prefetch_in_situ %view, %hmx
...
// CHECK-SAME: omni_fetch.layout_carried_sites = 1
// CHECK-SAME: omni_fetch.layout_carried_views = 1
// CHECK-NOT: memref.collapse_shape
// CHECK: omni_fetch.prefetch_in_situ %arg0, %arg1
// CHECK-SAME: omni_fetch.layout_carried_from_producer
// CHECK-SAME: omni_fetch.layout_carried_view_depth = 1
...
// CHECK-SAME: omni_fetch.layout_carried_sites = 0
// CHECK: memref.collapse_shape
// CHECK: omni_fetch.prefetch_in_situ %{{.*}}, %arg1
// CHECK-NOT: omni_fetch.layout_carried_from_producer

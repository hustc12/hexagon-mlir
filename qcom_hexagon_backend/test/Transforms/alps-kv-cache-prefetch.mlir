...
// CHECK-SAME: alps.kv_direct_layout_sites = 2
// CHECK-SAME: alps.kv_prefetch_bytes = 256
// CHECK-SAME: alps.kv_prefetch_hints = 4
// CHECK-SAME: alps.kv_prefetch_pages = 16
// CHECK-SAME: alps.kv_prefetch_sites = 2
// CHECK-SAME: alps.kv_rejected_produced_sites = 0
// CHECK: %[[K0:.+]] = memref.subview %arg1[0, 0, 0] [1, 1, 32] [1, 1, 1]
// CHECK: alps.l2_hint %[[K0]]
// CHECK: %[[K1:.+]] = memref.subview %arg1[1, 0, 0] [1, 1, 32] [1, 1, 1]
// CHECK: alps.l2_hint %[[K1]]
// CHECK: %[[V0:.+]] = memref.subview %arg3[0, 0, 0] [1, 1, 32] [1, 1, 1]
// CHECK: alps.l2_hint %[[V0]]
// CHECK: %[[V1:.+]] = memref.subview %arg3[1, 0, 0] [1, 1, 32] [1, 1, 1]
// CHECK: alps.l2_hint %[[V1]]
...
// CHECK-SAME: alps.kv_hoisted_sites = 1
// CHECK-SAME: alps.kv_prefetch_bytes = 64
// CHECK: %[[HK:.+]] = memref.subview %arg1[0, 0, 0] [1, 1, 32]
// CHECK: alps.l2_hint %[[HK]]
// CHECK: scf.for

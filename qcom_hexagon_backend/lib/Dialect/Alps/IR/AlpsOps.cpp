//===- AlpsOps.cpp - Alps Op Implementations  -------------------===//
//
...
//===----------------------------------------------------------------------===//
// AlpsDialect::registerOperations
//   Must be defined here (next to the ops) so the linker finds it.
//===----------------------------------------------------------------------===//
void AlpsDialect::registerOperations() {
  addOperations<
#define GET_OP_LIST
#include "hexagon/Dialect/Alps/IR/AlpsOps.cpp.inc"
  >();
}
...
//===----------------------------------------------------------------------===//
#include "hexagon/Dialect/Alps/IR/AlpsEnums.cpp.inc"
